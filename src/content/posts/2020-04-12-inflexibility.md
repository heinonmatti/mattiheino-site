---
title: "The Power of Inflexibility in Improving Science and Fighting COVID-19"
description: "Leveraging the minority rule to fight COVID-19 and shady research"
...
In case you're new to this blog, you might not be aware of the ongoing crisis of confidence—also known as the [Replication Crisis](https://en.wikipedia.org/wiki/Replication_crisis)—in social and life sciences, including but not limited to psychology, medicine and economics. (To learn more, see weeks I-II of my course [Critical Appraisal of Research Methods and Analysis](http://mattiheino.com/2019/09/04/carma/).)
...
![no_stretching_alora-griffiths-WX7FSaiYxK8-unsplash](./images/inflexibility/no_stretching_alora-griffiths-wx7fsaiyxk8-unsplash.jpg) No rest for the wicked, and no stretching for the inflexible! (Photo: [Alora Griffiths](https://unsplash.com/@aloragriffiths?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/stretching?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText))
...
**Lowering the cost of transparency:** In the scientific transparency scene, this means the minority representatives need to spend tons of time learning about transparent research practices (e.g. pre-registration and data sharing, the [TOP Factor](https://www.topfactor.org/), etc.). This knowledge they can then either disseminate to the rest of their research group, or act as the person who does most of the heavy lifting required in reporting reproducible work.

**Lowering the cost of Coronavirus safety**: The anti-Coronavirus advocates, on the other hand, need to make information easily available (as they do in [endcoronavirus.org](http://endcoronavirus.org)), share it, and translate it – both literally and figuratively. An example would be sharing [research studies](https://docs.google.com/document/d/1HLrm0pqBN_5bdyysOeoOBX4pt4oFDBhsC_jpblXpNtQ/mobilebasic), ways to [make](https://necsi.edu/sewing-masks) and [wear masks correctly](https://www.youtube.com/watch?v=OABvzu9e-hw), or how to acquire them (if you're in Finland, check [this](https://www.twelvetextiles.com/) out to have masks made for you, while donating some to healthcare workers). They may also need to learn about technicalities of video conferencing and other solutions, so that they can readily teach their peers after refusing face-to-face meetings.

**Not budging in research transparency**: The research transparency people obviously need to refuse co-authoring papers which contain p-hacking, hyperbole or other ways of distorting the findings to improve chances of publication. They need to refuse projects which do not plan to share analysis code (and data, within privacy constraints), [ask about transparency](https://twitter.com/Heinonmatti/status/1249368161830477824) before peer reviewing, and walk away from papers where the first author insists on presenting exploratory hypotheses as confirmatory ones, or is not willing to properly discuss constraints to generalisability, model assumptions (stationarity, homogeneity, independence, interference, ergodicity... see [here](http://mattiheino.com/2020/03/31/complexity-channel/) if these are strange words) and sensitivity analyses.
