---
title: "Työmarkkinoiden uudet vaateet"
description: "Työmarkkinoiden uudet vaateet"
...
2. **Suunnittelu**
   - *Ennakoi toimintojen etenemistä ja vaadittavia resursseja* – suojaa suunnitelmasi täystuhon varalta, mutta älä ylisuunnittele (ks. [tämä teksti](http://mattiheino.com/2014/03/16/lohdullinen-epavarmuus/) varautumiseen liittyen)
...
5. **Päätöksenteko**
   ...
   - *Tee hyviä päätöksiä monimutkaisissa tilanteissa* – helpommin sanottu kuin tehty? Apua saattaa löytyä näistä [teksteistä](http://mattiheino.com/category/parempaan-ajatteluun/).
...
10. **Oppimisen edistäminen**
    - *Paranna jatkuvasti käyttäytymismallejasi* – kokeile vaikka [unilateraalista sekasortoaltruismia](http://mattiheino.com/2014/07/14/unilateraalisen-sekasortoaltruismin-ohjelmajulistus/) päivän verran.
    ...
    - *Opi omasta kokemuksesta*si – epäonnistuminen on vain palautetta: löydä tilanteen opetus.
...
1. **Älä ole paskiainen.**
   - Jos ajattelet, että joku saattaa pitää sinua paskiaisena, mieti hyvin tarkasti, voisiko kyseessä olla ylpeytesi luoma harha (jolloin saatat todellisuudessa olla paskiainen). Voit myös käyttää tätä [muumiontunnistustaktiikkaa](http://mattiheino.com/2013/05/26/tunnista-muumiosi/).
2. **Tiedosta, ettet oikeastaan voi olla varma mistään.**
   - Jos et ole jumala, on aika hyväksyä maailman ennustamattomuus.
   - Kun laajennat vaihtoehtopalettiasi (esim. kehittämällä raportissa mainittuja taitoja), lisäät selviytymismahdollisuuksiasi (ks. [tämä teksti](http://mattiheino.com/2014/09/21/adaptiivinenmaisema/) adaptoitumisesta).
3. **Toimi.**
   - Jos kohdat 1. ja 2. ovat kunnossa, sinun tarvitsee enää pitää huoli siitä, että maailma muuttuu paremmaksi paikaksi. Tee *[jotain](http://mattiheino.com/2015/01/31/hyva-luoja/).* Luotan sinuun.
