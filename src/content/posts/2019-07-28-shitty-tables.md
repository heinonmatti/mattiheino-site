...
![shitty table 1](./images/shitty-tables/shitty-table-1.png) **Shitty Table 1.** Means and confidence intervals for lots of things. [Source](https://www.tandfonline.com/doi/full/10.1080/21642850.2019.1646136).
...
![shitty table 2](./images/shitty-tables/shitty-table-2.png) **Shitty Table 2.** Means, standard deviations and some distributional properties of a single variable in different educational tracks the participants were nested in. Nur = Practical nurse, HRC = Hotel, restaurant and catering studies, BA = Business and administration, IT = Business information technology. [Source](https://www.tandfonline.com/doi/full/10.1080/21642850.2019.1646136).
...
![pretty picture 1](./images/shitty-tables/pretty-picture-1.png) **Pretty Picture 1.** Visualising the information in Shitty Table 1 with raw data.
...
![pretty picture 3.PNG](./images/shitty-tables/pretty-picture-3.jpg) **Pretty Picture 3.** See [paper](https://www.tandfonline.com/doi/full/10.1080/21642850.2019.1646136) for elaboration.
