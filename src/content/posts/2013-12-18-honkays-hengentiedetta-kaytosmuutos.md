---
title: "Hönkäys Hengentiedettä: Mikä toimii käyttäytymistä muutettaessa?"
description: "Hönkäys Hengentiedettä: Mikä toimii käyttäytymistä muutettaessa?"
...
Tämä ei kuitenkaan tarkoita, että näyttöpohjaisen hoidon suosituksia tulisi kiistää - varsinkaan oman kokemuksen tai intuition pohjalta (oma näkemys on aina kapeampi kuin kokonaiskuva). Todistusaineiston vastustamisesta voit lukea lisää [täältä](http://blogs.helsinki.fi/hema/honkays-hengentiedetta-ebp/ "Hönkäys Hengentiedettä: Miksei näyttö vakuuta?").
