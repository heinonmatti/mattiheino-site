---
title: "Randomised experiments (mis?)informing social policy in complex systems"
description: "Decision making with experimental evidence? Mind the assumptions."
...
People in our [research group](https://www.helsinki.fi/en/researchgroups/behaviour-change-and-wellbeing) recently organised a [symposium](https://www.helsinki.fi/en/researchgroups/behaviour-change-and-wellbeing/behaviour-change-science-policy-besp), *Interdisciplinary perspectives on evaluating societal interventions to change behaviour* (talks watchable [here](https://vimeopro.com/user39826906/the-1st-besp-symposium)), as part of a series called Behaviour Change Science & Policy (BeSP). The idea is to bring together people from various fields from philosophy to behavioural sciences, medicine and beyond, in order to better tackle problems such as climate change and lifestyle diseases.

One presentation touched upon Finland's randomised controlled trial to test the [effects of basic income on employment](https://www.helsinki.fi/en/news/nordic-welfare-news/heikki-hiilamo-disappointing-results-from-the-finnish-basic-income-experiment) (see also [report](http://julkaisut.valtioneuvosto.fi/bitstream/handle/10024/161361/Report_The%20Basic%20Income%20Experiment%2020172018%20in%20Finland.pdf) on first year results). In crude summary, they did not detect effects of free money on finding employment. (Disclaimer: They had aimed for 80% statistical power, meaning that *if* all your assumptions regarding the size of the effect are correct, in the long term, 20% of the time you'd get no statistically significant effect in spite of there being a real effect.)
...
*Me:* I think they have huge consequences, and specifically in economics, this guy in Oxford just gave a presentation on what he called "[Complexity economics](https://www.youtube.com/watch?v=jd_GT73xwRc)". He had been doing it for some decades already, I think he originally had a physics background...
...
I have a lot of respect for the mathematical prowess of economists and econometricians, don't get me wrong. One of my favourites is Scott E. Page, though I only know him due to an excellent [course](https://www.thegreatcourses.com/courses/understanding-complexity.html) on complexity (also available as an [audio book](https://www.audible.com/pd/Understanding-Complexity-Audiobook/1629976849)). I do probably like him, because he breaks out of the monodisciplinary insulationist mindset economists are often accused of. Page's view of complexity actually relates to our conversation. Let's see how.
...
>
> - [Scott E. Page](https://www.thegreatcourses.com/courses/understanding-complexity.html)

- **Interdependence** means the extent of how much one person's actions affect those of another's. This dial ranges from complete independence, where one person's actions do not affect others' at all, to complete dependence, where everyone observes and tries to perfectly match all others' actions. In real life, we see both unexpected cascades (such as the US decision makers' ethanol regulations, [leading](https://necsi.edu/the-math-that-explains-the-world-the-arab-spring) to the Arab Spring), as well as some, but never complete, independence – that is, manifestations that do not fit into either extreme of the dial, but lie somewhere in between.
...
The society is a complex system, and must be studied as such. Figure: [Hiroki Sayama](https://twitter.com/HirokiSayama) (click to enlarge)
...
Let me hear your thoughts, and especially objections, on [Twitter](https://twitter.com/Heinonmatti/status/1152512398277918720?s=20), or by [email](mailto:matti.tj.heino@gmail.com)!

✱ One solution is to [harness convexity](https://www.edge.org/conversation/nassim_nicholas_taleb-understanding-is-a-poor-substitute-for-convexity-antifragility), which can be oversimplified like this:
