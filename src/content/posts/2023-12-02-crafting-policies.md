---
title: "Crafting Policies for an Interconnected World"
description: "Human centred policy for an age of uncertainty."
...
Reflecting on our pandemic response, mostly hierarchy-based and bureaucratic, we observed glaring [operational shortcomings](https://whn.global/scientific/cornerstone-of-pandemic-response/): delayed responses, disjointed actions, and ineffective execution of preparedness plans [[](https://www.zotero.org/google-docs/?9B4dAQ)[1]](https://whn.global/scientific/crafting-policies-for-an-interconnected-world/#1). However, what has been less discussed is the insight that the crisis offers into the role of uncertainty due to nonlinear risks in shaping policy outcomes.
