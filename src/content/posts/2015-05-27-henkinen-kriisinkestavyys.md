---
title: "Tuhoutumattomuuden tiellä: henkinen kriisinkestävyys"
description: "Sivuhuomio: ei muuten ole syytä uskoa, että väkivaltaisten konfliktien määrä olisi laskussa, päin vastoin: on arvioitu, että yli 10 000 kuolonuhria vaativa sota"
...
> - [Thomas Jefferson, 1763](http://en.wikiquote.org/wiki/Thomas_Jefferson#1760s "Wikiquote: Thomas Jefferson")

Olen eräässä [aiemmassa kirjoituksessa](http://blogs.helsinki.fi/hema/adaptiivinenmaisema/) esitellyt adaptiivisen maaston käsitteen, perustellen monipuolistumisen ja jatkuvan uudistumisen lisäksi varautumisen olevan välttämätöntä selviytymiselle. Mutta kuinka varautua odottamattomaan?
...
*Sivuhuomio: ei muuten ole syytä uskoa, että väkivaltaisten konfliktien määrä olisi laskussa, päin vastoin: on [arvioitu](https://medium.com/bull-market/violent-warfare-is-on-the-wane-right-99223faa45e6), että yli 10 000 kuolonuhria vaativa sota on globaalisti kolmisen kertaa todennäköisempi, kuin miltä se edellisen 70:n vuoden perusteella tuntuu.*

Tieteellinen tieto siitä, mikä ihmisen saa selviytymään ja jopa kasvamaan trauman seurauksena, on laajaa mutta yllättävän heikkolaatuista [1], ja tutkijoita onkin kehotettu korvaamaan määrää laadulla [2] (maksumuuriton johdanto traumanjälkeisestä kasvusta tehtyyn tutkimukseen [täällä](http://www.jubileecentre.ac.uk/userfiles/jubileecentre/pdf/conference-papers/Varieties_of_Virtue_Ethics/Jayawickreme_Eranda.pdf "Does Adversity Make Us Wiser Than Before? Addressing A Foundational Question")).
...
Olipa kerran Martti Maanviljelijä. Eräänä aurinkoisena päivänä Martin kyntöhevonen päättää vaihtaa alaa ja karata aitauksestaan. Martin naapurit tästä kuultuaan tulevat esittämään surunvalituksiaan; "kuinka harmillinen tapahtuma!". Martti tähän toteaa tyynesti "niin, suottaapi olla". Seuraavana päivänä kyntöhevonen palaa, tuoden mukanaan kolme villihevosta (kyllä, vielä oli villihevosia). Naapurit ihmettelevät äimän käkenä, "onpas upea tuuri!", mihin Martti taas toteaa "niin, suottaapi olla".
 ...
 [(Kuvalähde ja alkuperäistarina)](http://truecenterpublishing.com/zenstory/maybe.html)
...
Sivuhuomio: joillekin ihmisille on helpottavaa ajatella kaikilla tapahtumilla olevan tarkoituksensa. Itse en tällaisesta ajattelutavasta välitä (suhtautumiseni ns. [teodikea](http://fi.wikipedia.org/wiki/Pahan_ongelma)-ongelmaankin tiivistyy tässä [sarjakuvassa](http://www.smbc-comics.com/index.php?id=3723)); mutta jos se jollekulle toimii, niin mikäs siinä.
...
2) Eräässä aiemmassa [kirjoituksessa](http://blogs.helsinki.fi/hema/meditaatiomyytit/) mainitsemani "pimeän yön" kokemukset voivat olla hyvinkin rankkoja harjoituksen edetessä (jos tiedät, mitä tarkoitan, Facebookista löytyy nykyään "[Dark Night Support Group](https://www.facebook.com/groups/1421284884860338/?fref=ts)"-niminen ryhmä, josta saattaa olla hyötyä).
Jos meditaatiota haluaa kokeilla, alkuun pääsee maksutta esimerkiksi [calm.com](http://www.calm.com):n harjoitteilla tai (erit. kipu- ja stressikontekstissa) lataamalla tämän lyhyen [kirjasen](http://records.photodharma.net/texts/files-of-pain-stress-and-illness-by-bhikkhu-sumedha).
**Riskitaso III: Rakastu pysymättömyyteen**
Kerron toisen [tarinan](http://blogs.psychcentral.com/mindfulness/2010/10/is-your-glass-half-full-half-empty-or-broken/), josta pidän:
