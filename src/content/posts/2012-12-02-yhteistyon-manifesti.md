---
title: "Yhteistyön manifesti"
description: "Yhteistyön manifesti"
...
Ensinnäkin, onnellisuus ei ole sidottu ulkoisiin olosuhteisiimme ja niin lottovoittajat kuin neliraajahalvauspotilaat vaikuttavat palaavan - uskomatonta kyllä - melko nopeasti onnellisuutensa perustasolle. Toisekseen, ei ole mahdotonta, että tyytyväiset ihmiset suoriutuvat tehtävistä onnettomia paremmin, sen sijaan että syy-seuraussuhde olisi yksisuuntainen (onnistuminen -> tyytyväisyys). Kolmanneksi, muiden ihmisten auttaminen näyttää lisäävän auttajan omaa onnellisuutta: esimerkiksi saman rahamäärän käyttäminen toisen hyväksi voi lisätä hyvänolontunnetta enemmän, kuin sen käyttäminen itseen. Tämän kaiken huomioon ottaen voimme alkaa hahmottaa, miksi kannattaisi mieluummin käyttää aikansa jonkun muun auttamiseen kuin ulkoisten (esim. rahallisten) palkintojen individualistiseen tavoitteluun.
